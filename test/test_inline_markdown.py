...
class TestSplitNodes(unittest.TestCase):
    ...
    def test_split_italic_text(self):
        text_node = TextNode(text="This is _italic_ text", text_type=TextType.TEXT)
...
class TestTextToTextNodes(unittest.TestCase):
    def test_text_to_text_nodes(self):
        text = "This is **bold** and _italic_ text with `code` and an image ![alt text](https://example.com/image.png) and a link [GitHub](https://github.com)"
